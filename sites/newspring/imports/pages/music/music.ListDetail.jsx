        ...
        <div className="one-whole soft background--dark-primary" style={this.sectionStyles}>
          <div className="text-light-primary">
            <div className="grid floating push-bottom">
              <div className="grid__item background--fill floating__item text-left hard push-left ratio--square background--light-secondary one-eighth" style={{backgroundImage: `url(${this.props.album.content.images[2].url})`}}></div>
