...
h5 {font-size: 24px;}
h6 {font-size: 12px;}
body, table.body, p, td {font-size: 18px;line-height:21x;}
            ...
            <tr>
              <td>
                <table class="twelve columns">
                        <tr>
                          <td>
                            <img src="https://s3.amazonaws.com/uploads.hipchat.com/21097/1894749/qxrtjxe4LIEKwS3/logo.png">
                          </td>
                          <td class="expander"></td>
                        </tr>
                </table>
                  ...
                  <tr>
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h3>Hi, ' + user.emails[0].address + '</h3>
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <a href="' + url + '">
                              <img id="action" src="https://s3.amazonaws.com/uploads.hipchat.com/21097/1894749/it4rQ3gt75bE95S/action-btn.png">
                            </a>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <p class="url">Or use this link:</p>
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <br>
                            <br>
                            <h6>Our mailing address is:
                              <br>NewSpring Church
                              <br>PO Box 1407
                              <br>Anderson, SC 29622
                            </h6>
                          </td>
                        </tr>
                      </table>
