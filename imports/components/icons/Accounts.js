...
/**
 * set up base styles for all icons
 */
...
/**
 * Extend the base Icon styled with the background-image style for each type of icon
 */

const AmExIcon = styled(Icon)`
...
/**
 * make the exportable icons here by calling the extended icons with className
 * XXX if we didn't have classNames to pass, we could export the above icons :(
 */

const AmEx = ({ width, height }) =>
  <AmExIcon width={width} height={height} className="background--fill display-inline-block" />;


const Visa = ({ width, height }) =>
  <VisaIcon width={width} height={height} className="background--fill display-inline-block" />;


const Discover = ({ width, height }) =>
  <DiscoverIcon width={width} height={height} className="background--fill display-inline-block" />;


const MasterCard = ({ width, height }) =>
  <MasterCardIcon width={width} height={height} className="background--fill display-inline-block" />;


const Bank = ({ width, height }) =>
  <BankIcon width={width} height={height} className="background--fill display-inline-block" />;
...
Discover.propTypes = iconPropTypes;
Visa.propTypes = iconPropTypes;
AmEx.propTypes = iconPropTypes;
