...
export default class Content extends Component {
  ...
  render() {
    ...
    return (
      <section className={this.getClasses()} style={{ transition: "0.7s margin" }}>
        {!studyEntry.content.wistiaId &&
        ...
        {studyEntry.content.wistiaId && <Video id={studyEntry.content.wistiaId} />}
