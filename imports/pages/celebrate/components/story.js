  ...
  <div className="grid soft-double-bottom soft-double-top@lap-and-up">
    <div className="constrain-page">
      ...
      <div className={`grid__item ${image && "two-thirds@lap-and-up"} floating text-center text-left@lap-and-up display-inline-block`} style={{ verticalAlign: "middle" }}>
        {heading && name && location && <h5 className={`${contentClass} soft-half-bottom soft-sides@handheld`} style={{ fontWeight: "400" }}>{heading} <strong style={{ fontFamily: "colfax, sans-serif" }}>{name}</strong> from <strong style={{ fontFamily: "colfax, sans-serif" }}>{location}</strong>.</h5>}
        ...
        <div dangerouslySetInnerHTML={{ __html: content }} className={`${contentClass} soft-sides@palm-wide`} />
