...
import Confirm from "../../../../blocks/action-buttons";
import AddSchedule from "../../../../blocks/add-schedule";
import Split, { Left, Right } from "../../../../blocks/split";

import { Spinner } from "../../../../components/loading";
import { Error as ErrIcon } from "../../../../components/icons";
...
export default class Layout extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div>
          <Split nav classes={recoverableSchedules.length ? ["background--light-secondary"] : ["background--light-primary"]} >
