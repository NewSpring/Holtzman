...
const Layout = ({ schedules, reminderDate, onClick, hide }) => (
  <div className="soft soft-double-ends one-whole text-center">
    ...
    <p className="push-top text-left">
      <em>
        <small>
          You can cancel your schedule at any time from the Scheduled Giving page.
          If you have any questions please call our Finance Team at 864-965-9990 or
          <a target="_blank" href="//rock.newspring.cc/workflows/152?Topic=Stewardship">contact us</a>
