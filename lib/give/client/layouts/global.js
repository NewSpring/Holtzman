...
var _coreClientLayouts = require("../../../core/client/layouts");
...
var _coreClientMiddlewares = require("../../../core/client/middlewares");

_coreClientMiddlewares.addMiddleware(_rockClientMiddlewares.onBoard);
...
var Layout = (function (_Component) {
  ...
  function Layout() {
    ...
    this.setLoggedIn = function (user) {
      _this.props.dispatch(_coreClientActions.onBoard.authorize(user != null));
    };
  }
