...
var cancelBilling = function cancelBilling(customer, callback) {

  var cancelBillingObj = {
    "delete-customer": {
  ...
  var xml = builder.buildObject(cancelBillingObj);
