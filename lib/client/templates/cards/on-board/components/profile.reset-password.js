var doneCallback, extend = function (child, parent) {
...
profile.resetPassword = (function (superClass) {
    ...
    resetPassword.register("profile.resetPassword");

    resetPassword.card("Apollos.profile.onBoard");

    resetPassword.prototype.url = "reset-password";
