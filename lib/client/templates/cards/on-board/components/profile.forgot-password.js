...
profile.forgotPassword = (function (superClass) {
    ...
    forgotPassword.register("profile.forgotPassword");

    forgotPassword.card("Apollos.profile.onBoard");

    forgotPassword.prototype.url = "forgot-password";
