...
Apollos.group.translate = function (group, platform) {
...
Apollos.group.update = function (group, platform) {
...
Apollos.group["delete"] = function (group, platform) {
    return Apollos.documentHelpers["delete"]("group", "groups", group, platform);
};