...
Apollos.location.translate = function (location, platform) {
...
Apollos.location.update = function (location, platform) {
...
Apollos.location["delete"] = function (location, platform) {
    return Apollos.documentHelpers["delete"]("location", "locations", location, platform);
};