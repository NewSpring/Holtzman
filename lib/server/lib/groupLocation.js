...
Apollos.groupLocation.translate = function (groupLocation, platform) {
...
Apollos.groupLocation.update = function (groupLocation, platform) {
...
Apollos.groupLocation["delete"] = function (groupLocation, platform) {
    return Apollos.documentHelpers["delete"]("groupLocation", "groupLocations", groupLocation, platform);
};