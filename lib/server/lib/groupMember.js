...
Apollos.groupMember.translate = function (groupMember, platform) {
...
Apollos.groupMember.update = function (groupMember, platform) {
...
Apollos.groupMember["delete"] = function (groupMember, platform) {
    return Apollos.documentHelpers["delete"]("groupMember", "groupMembers", groupMember, platform);
};