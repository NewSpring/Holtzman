...
this.Location = new SimpleSchema({
    locationId: {
        type: Number
    },
    campusId: {
...
this.SavedAccount = new SimpleSchema({
    savedAccountId: {
        type: Number
    },
    personAliasId: {
...
this.Transaction = new SimpleSchema({
    transactionId: {
        type: Number
    },
...
this.ScheduledTransaction = new SimpleSchema({
    scheduledTransactionId: {
        type: Number
    },
    personAliasId: {
