...
var _utilInherit = require("../util/inherit");
...
function makeErrorType(name, constructor) {
  ...
  _utilInherit.inherit(errorClass, Error);
...
var ApollosError = makeErrorType("Apollos.Error", function (error, reason, details) {
