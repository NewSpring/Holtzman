...
XML.prototype.parse = function (branch, name) {
  ...
  while (matches = this.patTag.exec(this.text)) {
    ...
    if (tag.match(this.patSpecialTag)) {
      // special tag
      if (tag.match(this.patPITag)) tag = this.parsePINode(tag);else if (tag.match(this.patCommentTag)) tag = this.parseCommentNode(tag);else if (tag.match(this.patDTDTag)) tag = this.parseDTDNode(tag);else if (tag.match(this.patCDATATag)) {
...
var always_array = exports.alwaysArray = function always_array(obj, key) {
  ...
  if (key) {
    if ((0, _typeof3["default"])(obj[key]) != "object" || typeof obj[key].length == "undefined") {
      var temp = obj[key];
      delete obj[key];
      obj[key] = new Array();
      obj[key][0] = temp;
    ...
    if ((typeof obj === "undefined" ? "undefined" : (0, _typeof3["default"])(obj)) != "object" || typeof obj.length == "undefined") {
      return [obj];
    } else return obj;
  }
};
...
var isa_hash = exports.isaHash = function isa_hash(arg) {
  ...
  return !!arg && (typeof arg === "undefined" ? "undefined" : (0, _typeof3["default"])(arg)) == "object" && typeof arg.length == "undefined";
};
