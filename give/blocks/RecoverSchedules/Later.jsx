...
const Later = ({ date, onClick }) => (
  <div className="soft soft-double-ends one-whole text-center">
    ...
    <p className="text-left">
      ...
      If you would like to reset your schedules before then, please contact our Finance Team at 864-965-9990 or email us at <a href="mailto:finance@newspring.cc">finance@newspring.cc</a>
    </p>
